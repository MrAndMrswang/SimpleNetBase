...
TcpConnection::TcpConnection(EventLoop* loop,const string& nameArg,int sockfd,const InetAddress& 			localAddr, const InetAddress& peerAddr):/*loop_(CHECK_NOTNULL(loop))*/
...
void TcpConnection::connectEstablished()
{
	...
	printf("TcpConnection::connectEstablished()\n");
}
...
void TcpConnection::handleClose()
{
	...
	printf("void TcpConnection::handleClose()");
